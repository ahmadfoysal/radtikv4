...
class RouterSubscriptionServiceTest extends TestCase
{
    ...
    public function test_subscribe_new_router_creates_router_and_debits_balance(): void
    {
        ...
        $this->assertNotNull($router->package_start_date);
        $this->assertNotNull($router->package_end_date);
        $this->assertTrue($router->package_end_date->greaterThan($router->package_start_date));
    ...
    public function test_renew_router_extends_subscription(): void
    {
        ...
        $router = $this->service->subscribeNewRouter($user, $package, $routerData);
        $firstEndDate = $router->package_end_date;
        ...
        $this->assertTrue($renewedRouter->package_end_date->greaterThan($firstEndDate));
