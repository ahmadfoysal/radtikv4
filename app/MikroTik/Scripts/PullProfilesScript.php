...
# Syncs profiles with inline on-login logic
...
:log info "RADTik: Fetching profiles"
SCRIPT;

        // Now replace placeholders with actual values
        $script = str_replace('BASEURL_PLACEHOLDER', $baseUrl, $script);
        $script = str_replace('TOKEN_PLACEHOLDER', $token, $script);
