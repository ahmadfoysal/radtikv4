    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                ...
                'category' => 'billing',
                'content' => "Automatic renewal is a powerful feature that ensures uninterrupted service for your subscription.\n\nHow It Works:\nWhen automatic renewal is enabled, the system will automatically attempt to renew your subscription when it's about to expire.\n\nRenewal Process:\n1. The system checks for expiring subscriptions 7 days before expiration\n2. If auto-renew is enabled and you have sufficient balance, renewal is processed\n3. Payment is deducted from your account balance\n4. A new billing cycle begins immediately\n5. You receive notification of successful renewal\n\nEnabling Auto-Renewal:\n- Go to your subscription page\n- Your subscription has auto-renewal enabled by default\n- Ensure your account has sufficient balance\n\nBenefits:\n- No service interruption\n- Hands-free management\n- Automated billing\n- Email notifications keep you informed\n\nNote: Auto-renewal requires sufficient account balance. If balance is insufficient, renewal will fail and you'll receive a notification.",
                'is_active' => true,
            ],
            [
