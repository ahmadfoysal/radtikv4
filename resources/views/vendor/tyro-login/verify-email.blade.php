        ...
        @if (in_array($layout, ['split-left', 'split-right']))
            <div class="background-panel" style="background-image: url('{{ $backgroundImage }}');">
                <div class="background-panel-content">
                    ...
                    <p>{{ $pageContent['background_description'] ?? 'We\'ve sent a verification link to your email address. Click the link to verify your account.' }}
                    </p>
                </div>
            </div>
        @endif
        ...
        <div class="form-panel">
            <div class="form-card">
                ...
                <div class="verify-instructions">
                    <p>Click the link in your email to verify your account. If you don't see the email, check your spam
                        folder.</p>
                </div>
