        ...
        @if (in_array($layout, ['split-left', 'split-right']))
            <div class="background-panel" style="background-image: url('{{ $backgroundImage }}');">
                <div class="background-panel-content">
                    ...
                    <p>{{ $pageContent['background_description'] ?? 'Your email address needs to be verified before you can access your account.' }}
                    </p>
                </div>
            </div>
        @endif
        ...
        <div class="form-panel">
            <div class="form-card">
                ...
                <div class="verify-instructions">
                    <p>Please check your inbox and click the verification link to activate your account. If you don't see
