        ...
        @if (in_array($layout, ['split-left', 'split-right']))
            <div class="background-panel" style="background-image: url('{{ $backgroundImage }}');">
                <div class="background-panel-content">
                    ...
                    <p>{{ $pageContent['background_description'] ?? 'Create your account and start your journey with us. It only takes a minute to get started.' }}
                    </p>
                </div>
            </div>
        @endif
                ...
                <form method="POST" action="{{ route('tyro-login.register.submit') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password"
                            ...
                            placeholder="Password" minlength="{{ config('tyro-login.password.min_length', 8) }}">
                        @error('password')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    @if ($requirePasswordConfirmation ?? true)
                        <div class="form-group">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation"
                                class="form-input @error('password_confirmation') is-invalid @enderror" required
