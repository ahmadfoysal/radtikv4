<div class="space-y-6">
    ...
    <x-mary-card class="border border-base-300 bg-base-100">
        <div class="text-center py-8">
            ...
            <p class="text-base-content/70 mb-6">Your account is being set up. Please contact your administrator to
                assign a role and permissions.</p>
            <div class="flex gap-4 justify-center">
                <x-mary-button icon="o-user" label="View Profile" class="btn-primary"
                    href="{{ route('settings.profile') }}" wire:navigate />
                <x-mary-button icon="o-cog-6-tooth" label="Settings" class="btn-outline"
                    href="{{ route('settings.profile') }}" wire:navigate />
            </div>
        </div>
    </x-mary-card>
            ...
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <div class="space-y-2 mt-3">
                        <x-mary-button icon="o-user" label="Update Profile" class="btn-sm btn-outline btn-block"
                            href="{{ route('settings.profile') }}" wire:navigate />
                        <x-mary-button icon="o-key" label="Change Password" class="btn-sm btn-outline btn-block"
                            href="{{ route('settings.security') }}" wire:navigate />
                    </div>
                </div>
            </div>
        </x-mary-card>
        ...
        <x-mary-card class="border border-base-300 bg-base-100">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <x-mary-button icon="o-envelope" label="Contact Support" class="btn-sm btn-primary btn-block"
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-base-content/70">Your administrator will assign you a role (Admin or
                        Reseller) with appropriate permissions.</p>
                </div>
            </div>
            <div class="flex items-start gap-3">
                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-base-content/70">Once assigned, you'll have access to routers, vouchers, and
                        other features based on your role.</p>
                </div>
            </div>
        </div>
    </x-mary-card>
    ...
    <div class="grid gap-4 grid-cols-1 lg:grid-cols-2">
        ...
        <x-mary-card class="border border-base-300 bg-base-100">
            ...
            <div class="space-y-3">
                ...
                <div class="pt-2">
                    <x-mary-button icon="o-pencil" label="Edit Profile" class="btn-sm btn-outline btn-block"
                        href="{{ route('settings.profile') }}" wire:navigate />
                </div>
            </div>
        </x-mary-card>
