<div class="w-full max-w-6xl mx-auto px-4 py-6">
    {{-- Header Section --}}
    <div class="mb-6">
        <x-mary-button icon="o-arrow-left" label="Back to Documentation" class="btn-sm btn-ghost mb-4"
            href="{{ route('docs.index') }}" wire:navigate />
        
        <div class="flex items-center gap-2 mb-3">
            <x-mary-badge value="{{ ucfirst($article->category) }}" class="badge-primary badge-lg" />
            <span class="text-sm text-base-content/60">Documentation</span>
        </div>
    </div>
        ...
        <article class="lg:col-span-8">
            <x-mary-card class="bg-base-100 border border-base-300 shadow-sm">
                ...
                <div class="mt-8 pt-6 border-t border-base-300 flex items-center justify-between">
                    <x-mary-button icon="o-arrow-left" label="Back to Documentation" class="btn-sm btn-ghost"
                        href="{{ route('docs.index') }}" wire:navigate />
        ...
        <aside class="lg:col-span-4">
            <div class="space-y-4 sticky top-6">
                ...
                <x-mary-card class="bg-base-100 border border-base-300">
                    ...
                    <div class="space-y-2">
                        <x-mary-button icon="o-arrow-left" label="All Documentation" class="btn-sm btn-block btn-ghost justify-start"
                            href="{{ route('docs.index') }}" wire:navigate />
                        <x-mary-button icon="o-book-open" label="Knowledge Base" class="btn-sm btn-block btn-ghost justify-start"
                ...
                <x-mary-card class="bg-base-100 border border-base-300">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <x-mary-badge value="{{ ucfirst($article->category) }}" class="badge-primary badge-sm" />
                        </div>
                        <div class="flex items-center justify-between">
