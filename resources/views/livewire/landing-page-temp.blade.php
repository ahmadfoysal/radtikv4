...
<head>
    ...
    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="card bg-base-200 shadow-xl feature-card">
                        <div class="card-body">
                            ...
                            <p class="text-base-content/70">
                                Centrally manage multiple MikroTik routers with real-time monitoring, configuration
                                updates,
                    ...
                    <div class="card bg-base-200 shadow-xl feature-card">
                        <div class="card-body">
                            ...
                            <p class="text-base-content/70">
                                Integrated payment processing with multiple gateways, automated invoicing, and
                                subscription
                    ...
                    <div class="card bg-base-200 shadow-xl feature-card">
                        <div class="card-body">
                            ...
                            <p class="text-base-content/70">
                                Perfect for resellers and ISPs. Manage multiple customers with isolated environments,
                                custom
                    ...
                    <div class="card bg-base-200 shadow-xl feature-card">
                        <div class="card-body">
                            ...
                            <p class="text-base-content/70">
                                Built-in ticketing system with knowledgebase, documentation, and priority support to
                                keep
        ...
        <a href="https://wa.me/8801303705753" target="_blank" rel="noopener noreferrer"
            aria-label="Chat on WhatsApp" class="whatsapp-float">
