    ...
    <x-mary-card class="mb-4 bg-base-100 border border-base-300 shadow-sm">
        <div class="px-4 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-2">
                <x-mary-icon name="o-user-minus" class="w-6 h-6 text-primary" />
                <span class="font-semibold text-lg">Hotspot Session Cookies</span>
            </div>
                ...
                <table class="table table-zebra w-full">
                    ...
                    <tbody>
                        @foreach($cookies as $cookie)
                            <tr>
                                <td class="font-medium">{{ $cookie['user'] ?? 'N/A' }}</td>
        ...
        @elseif(!$router_id)
            <x-mary-card class="bg-base-100">
                <div class="p-8 text-center opacity-70">
                    ...
                    <p>Please select a router to view session cookies.</p>
                </div>
            </x-mary-card>
        @endif
        ...
        @if($loading)
            <x-mary-card class="bg-base-100">
                <div class="p-8 text-center">
                    ...
                    <p class="mt-2">Loading session cookies...</p>
                </div>
            </x-mary-card>
        @endif
    </div>
