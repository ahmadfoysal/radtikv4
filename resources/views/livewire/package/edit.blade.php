<x-mary-card title="Edit Package" separator class="max-w-4xl mx-auto rounded-2xl bg-base-200">
    <x-mary-form wire:submit="update">
        ...
        <x-slot:actions>
            ...
            <x-mary-button label="Update Package" class="btn-primary" type="submit" spinner="update" />
        </x-slot:actions>
    </x-mary-form>
</x-mary-card>
