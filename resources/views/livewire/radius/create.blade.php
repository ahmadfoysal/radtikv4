    ...
    <x-mary-form wire:submit="save">
        ...
        <div class="mb-6">
            <x-mary-checkbox label="Auto-Provision on Linode" wire:model.live="auto_provision" 
                hint="Automatically create a Linode instance in Singapore (1GB/$5/month, Ubuntu 22.04) with auto-configured FreeRADIUS" />
        </div>

        {{-- Manual Configuration (only if auto_provision is false) --}}
        @if(!$auto_provision)
            <div class="mb-6">
