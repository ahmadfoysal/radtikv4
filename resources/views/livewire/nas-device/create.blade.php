<x-mary-card title="Add NAS Device" separator class="max-w-4xl mx-auto bg-base-100">
    <x-mary-form wire:submit="save">
        ...
        <x-slot:actions>
            ...
            <x-mary-button label="Save NAS Device" class="btn-primary" type="submit" spinner="save" />
        </x-slot:actions>
    </x-mary-form>
</x-mary-card>
