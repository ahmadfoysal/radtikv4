<div class="max-w-7xl mx-auto space-y-6">
    ...
    <x-mary-card title="Email & SMTP Settings" separator class="bg-base-100">
        <p class="text-sm text-base-content/70 mb-6">
            <span class="font-semibold text-warning">Superadmin Access:</span> Configure email delivery settings for the entire system. 
            ...
            <x-mary-card title="SMTP Configuration" separator class="bg-base-100">
                <x-mary-form wire:submit="saveSettings">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <x-mary-input 
                            label="SMTP Port" 
                            wire:model.live="mail_port"
                            type="number"
                            min="1"
                            max="65535"
                            placeholder="587"
                            hint="Usually 587 for TLS, 465 for SSL"
                            icon="o-hashtag"
                        />
                        ...
                        <x-mary-input 
                            ...
                            wire:model.live="mail_from_address"
                            type="email"
                        ...
                        <x-mary-input 
                            label="From Name" 
                            wire:model.live="mail_from_name"
                            placeholder="RADTik System"
                    ...
                    <div class="mt-6 pt-6 border-t border-base-300">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            <x-mary-toggle 
                                ...
                                wire:model.live="notifications_enabled"
                        ...
                        <x-mary-input 
                            ...
                            wire:model.live="test_email_address"
                            type="email"
                            placeholder="test@example.com"
                            hint="Email address for testing configuration"
                            icon="o-envelope"
                            class="max-w-md"
                        />
                    </div>
            ...
            <x-mary-card title="Test Configuration" class="bg-base-100">
                <div class="space-y-4">
                    ...
                    <x-mary-button 
                        ...
                        :spinner="$isTestingEmail"
                        icon="o-paper-airplane"
                        :disabled="empty($test_email_address)"
                    />
            ...
            <x-mary-card title="Current Status" class="bg-base-100">
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <x-mary-badge 
                            :value="strtoupper($mail_encryption)" 
                            :class="$mail_encryption === 'tls' ? 'badge-success' : ($mail_encryption === 'ssl' ? 'badge-warning' : 'badge-error')" 
                        />
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <x-mary-badge 
                            :value="$notifications_enabled ? 'Enabled' : 'Disabled'" 
                            :class="$notifications_enabled ? 'badge-success' : 'badge-error'" 
                        />
                    </div>
                </div>
            </x-mary-card>
